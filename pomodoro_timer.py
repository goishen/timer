...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 21 11:37:30 2020
...
#         self.title("Pomodoro Timin' yo ass")
#         self.columnconfigure(0, weight=1)
#         self.rowconfigure(1, weight=1)
#         self.geometry("640x480")  #just because I'm lazy and don't wanna be expanding the window manually
        
#         container = ttk.Frame(self)
#         container.grid()
#         container.columnconfigure(0, weight=1)
        
#         self.pomodoro = tk.StringVar(value=5)
#         self.long_break = tk.StringVar(value=3)
#         self.short_break = tk.StringVar(value=2)
        
#         self.timer_order = ["Pomodoro", "Short break", "Pomodoro", "Short break", "Pomodoro", "Long break"]
#         self.timer_schedule = deque(self.timer_order)    
        
        
#         quit_button = ttk.Button(self, text="Quit", command=self.destroy, cursor="hand2")
        
#         timer_frame = Timer(container, self)
#         timer_frame.grid(row=0, column=0, sticky="NSEW")
#         quit_button.grid(row=1, column=0, padx=(10,10), pady=(10,10))   
#         self.bind("<Return>", quit_button)  #  Wonder why this won't work?
...
class Timer(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        self.start_button = ttk.Button(button_container, text="Start", command=self.start_timer, cursor="sailboat")
        self.start_button.grid(row=0, column=0, sticky="EW")
        
        self.stop_button = ttk.Button(button_container, text="Stop", state="disabled", command=self.stop_timer, cursor="spider")
        self.stop_button.grid(row=0, column=1, sticky="EW", padx=5)

        reset_button = ttk.Button(button_container, text="Reset", command=self.reset_button, cursor="umbrella")
        ...
        if self.timer_running and current_time != "00:00":
            ...
            if next_up == "Pomodoro":
               ...
               # self.current_time.set("05:00")
                ...
                short_break_time = int(self.contrller.short_break.get())
